-- Seed cho Supabase CLI: chạy sau migrations khi `supabase db reset` (local).
-- Trên project Supabase cloud: mở SQL Editor, dán nội dung file db/seed.sql (giống file này) và Run.
--
-- (Đồng bộ với db/seed.sql.)

-- =============================================================================
-- Seed dữ liệu mẫu (chi nhánh + món ăn) — chạy SAU migration / schema.sql
