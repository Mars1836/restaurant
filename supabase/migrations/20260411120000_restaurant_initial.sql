-- Migration: branches, menu_items, reservations
-- Áp dụng remote: Supabase Dashboard → SQL → dán và Run, HOẶC: supabase link + supabase db push
-- (Nội dung đồng bộ với db/schema.sql — sửa schema thì cập nhật cả hai nơi.)
